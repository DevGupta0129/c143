...
export default class HomeScreen extends Component {
  constructor(props) {
    ...
    this.state={
      movieDetails: {},
      ngrok_url:"https://2cc1-2405-201-d00b-1188-2dcb-5a4b-df8a-eb35.ngrok-free.app/"
    }
  }
          ...
          >
            ...
            <View style={styles.subContainer}>
              ...
              <View style={{flex:0.15}}>
                 ...
                 <View style={styles.detailsContainer}> <Text style={styles.title}>{original_title}</Text> <Text style={styles.subtitle}> {release_date.split("-")[0]} | {duration} mins </Text> </View> 
              ...
              <View style={styles.iconButtonContainer}>
                ...
                <TouchableOpacity onPress={this.likedMovie}> <Image style={styles.iconImage} source={require("../assets/like.png")} /> </TouchableOpacity> <TouchableOpacity onPress={this.dislikedMovie}> <Image style={styles.iconImage} source={require("../assets/dislike.png")} /> </TouchableOpacity> <TouchableOpacity onPress={this.notWatched}> <Image style={styles.iconImage} source={require("../assets/didNotWatch.png")} /> </TouchableOpacity> </View> </View>
